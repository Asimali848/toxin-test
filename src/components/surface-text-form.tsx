      ...
      <CardContent>
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-foreground">Location A Details</h4>
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-foreground">Location B Details</h4>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="roomName">Room Name</Label>
                  <Input
          ...
          <div className="mt-4 rounded-lg border border-border bg-muted/10 p-3">
            ...
            <div className="grid max-h-64 grid-cols-1 gap-3 overflow-auto sm:grid-cols-3">
              <Input
                type="text"
                id="doorJamb"
