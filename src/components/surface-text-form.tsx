      ...
      <CardContent>
        ...
        >
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  />
                  <GuidanceBlock metricKey="leadPaintXRF" value={surfaceData.leadPaintRoom1} />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-background"
                  />
                  <GuidanceBlock metricKey="leadPaintXRF" value={surfaceData.leadPaintRoom2} />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background"
              />
              <GuidanceBlock metricKey="surfaceMold" value={surfaceData.mold} />
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                   ...
                   id="windowSill"
                    ...
                    className="bg-background"
                  />
                  <GuidanceBlock metricKey="windowSill" value={surfaceData.windowSill} />
                </div>
              </div>
          ...
          <div className="mt-4 rounded-lg border border-border p-3 bg-muted/10">
            <h4 className="font-medium text-foreground mb-2">More Locations (optional)</h4>
            <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 max-h-64 overflow-auto">
              <Input
               type="text"
               id="doorJamb"
